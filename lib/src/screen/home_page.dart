...
class _HomePageState extends State<HomePage>
  ...
  void _signIn() async {
    try {
      ...
      print('Attempting LINE Login with options: $loginOption');

      final result = await LineSDK.instance
          .login(scopes: _selectedScopes.toList(), option: loginOption);

      print('LINE Login successful. User ID: ${result.userProfile?.userId}');
      ...
      print('LINE Login Error: ${e.code} - ${e.message}');
      print('Error Details: ${e.details}');
      _showDialog(
          context, 'LINE Login Error: ${e.message}\nDetails: ${e.details}');
    } catch (e) {
      print('Unexpected error during LINE Login: $e');
